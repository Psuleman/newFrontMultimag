...
const CategorieEn = () => {
    //variable
    const {categorieEnUpdate, setCategorieEnUpdate, sousCategorieEnUpdate, setSousCategorieEnUpdate, filtreEnUpdate, setFiltreEnUpdate} = useContext(FormulaireContext)
    //render
    return (
