...
class UserFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $Users =[
            ...
            ["nom"=>"Hadida", "prenom"=>"Charles", "email"=>"charles.hadida@leclaireur.com", "password"=>"wqV3iCcctbUA", "service"=>"Comptabilité"],
            ...
            ["nom"=>"Leclaireur", "prenom"=>"Lydia", "email"=>"lydia@leclaireur.com", "password"=>"mkm3LA6Z55LQ", "service"=>"Comptabilité"],
