 ...
 */
final class Version20221114165244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE variants (id INT AUTO_INCREMENT NOT NULL, sku_id INT DEFAULT NULL, taille_ref_id INT DEFAULT NULL, taille_fnr VARCHAR(255) NOT NULL, variant_sku VARCHAR(255) DEFAULT NULL, INDEX IDX_B39853E11777D41C (sku_id), INDEX IDX_B39853E14138998F (taille_ref_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stockage DROP FOREIGN KEY FK_CABCB49222D73CA');
