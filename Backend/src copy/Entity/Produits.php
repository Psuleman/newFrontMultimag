...
class Produits
{
    ...
    #[ORM\OneToMany(mappedBy: 'produit', targetEntity: MatiereProduit::class,  cascade: ['persist'])]
    ...
    {
            // $oldMatiere = $this->getMatiereProduits();
            
            // foreach ($matieres as $value) {
            //     # code...
            //     $matiereProduit = new MatiereProduit();
            //     foreach ($value as $cle => $valeur) {
            //         # code...
            //         if($cle == "matiere"){
            //             $matiereProduit->setMatiere(new Matiere(["matiere"=>$valeur, "matiere_en"=>""]));
            //         }
            //         if($cle == "pourcentageMatiere"){
            //             $matiereProduit->setPourcentageMatiere($valeur);
            //         }
            ...
            //      * comparaison 
            //      */
            //     if($oldMatiere && count($oldMatiere)){
            //         foreach ($oldMatiere as $value) {
            //             # code...
            //             if($value->getMatiere() && $value->getMatiere()->getMatiere() == $matiereProduit->getMatiere()->getMatiere()){
            //                 $pourcentage = $matiereProduit->getPourcentageMatiere();
            //                 $matiereProduit=$value;
            //                 $matiereProduit->setPourcentageMatiere($pourcentage);
            //             }
            //         }                
            //     }

            //     $this->addMatiereProduit($matiereProduit);
